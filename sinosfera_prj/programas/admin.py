...
class ProgramaAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('id',)
    list_display = ('get_item_id', 'plano_vinculado_ao_programa', 'nome', 'prazo_de_execucao_do_programa', 'escopo_geografico_do_programa', 'municipio_ancora_do_programa', 'instituicao_ancora_do_programa', 'pessoa_ancora_do_programa',)
    # search_fields = ('nome',)
    # ordering = ('id', 'nome',)
...
class Diretriz_especifica_de_programaAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('id',)
    list_display = ('get_item_id', 'programa_vinculado_a_diretriz_especifica', 'nome',)
    # search_fields = ('nome',)
    # ordering = ('id', 'nome',)
    # list_filter = ('municipio_ancora_do_programa',)