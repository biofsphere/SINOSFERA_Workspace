    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('atualizado_por', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='perfis_atualizados', to=settings.AUTH_USER_MODEL)),
                ('conta_associada', models.OneToOneField(blank=True, help_text='Selecione a conta associada à pessoa se houver', null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Conta associada à pessoa')),
                ('criado_por', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='perfis_criados', to=settings.AUTH_USER_MODEL)),
