    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(help_text='Selecione o usuario do sistema responsável pela inserção dos dados', null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Dados inseridos por')),
            ],
            options={
                'verbose_name': 'Pessoa',
