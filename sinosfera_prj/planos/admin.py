...
class PlanoAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('id',)
    list_display = ('get_item_id', 'categoria', 'nome', 'prazo_de_execucao_do_plano', 'escopo_geografico_do_plano', 'municipio_ancora_do_plano', 'instituicao_ancora_do_plano', 'pessoa_ancora_do_plano',)
...
class Programa_de_acoes_prioritariasAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('id',)
    list_display = ('get_item_id', 'nome', 'plano_vinculado_ao_programa_de_acoes_prioritarias', 'coordenador',)
    # search_fields = ('nome_completo',)
    # ordering = ('id', 'nome_completo',)
...
class Acao_prioritariaAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('id',)
    list_display = ('get_item_id',  'programa_de_acoes_prioritarias_vinculado', 'nome', 'coordenador',)
    # search_fields = ('nome',)
    # ordering = ('id', 'nome',)
    # list_filter = ('municipio_de_trabalho_da_pessoa',)