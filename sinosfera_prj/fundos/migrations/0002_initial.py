...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='pedido',
            name='atualizado_por',
            field=models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pedidos_atualizados', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='pedido',
            name='criado_por',
            field=models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pedidos_criados', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='pedido',
            name='item',
            field=models.ForeignKey(blank=True, help_text='Selecione um item para este pedido', null=True, on_delete=django.db.models.deletion.CASCADE, to='fundos.item'),
        ),
        migrations.AddField(
            model_name='pedido',
            name='orcamento',
            field=models.ForeignKey(blank=True, help_text='Selecione em que orçamento esse pedido se insere.', null=True, on_delete=django.db.models.deletion.CASCADE, to='fundos.orcamento'),
        ),
        migrations.AddField(
            model_name='pedido',
            name='tipo',
            field=models.ForeignKey(blank=True, help_text='Selecione a categoria de despesa.', null=True, on_delete=django.db.models.deletion.CASCADE, to='categorias.categoria_de_despesa', verbose_name='Tipo de despesa'),
        ),
        migrations.AddField(
