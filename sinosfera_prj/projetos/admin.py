...
class ProjetoAdmin(admin.ModelAdmin):
    fields = ('id', 'programa_vinculado_ao_projeto', 'nome', 'objetivo_geral_do_projeto', 'encerrado', 'resumo_descritivo_do_projeto', 'fundos_de_execucao_do_projeto', 'fundos_estimados_do_verde_sinos', 'fundos_estimados_de_contra_partida', 'valor_total_do_projeto', 'municipio_ancora_do_projeto', 'urs_vinculadas_ao_projeto', 'instituicao_ancora_do_projeto', 'pessoa_ancora_do_projeto', 'inicio', 'fim',)
    readonly_fields = ('id',)
    list_display = ('id', 'programa_vinculado_ao_projeto', 'nome', 'encerrado', 'fundos_de_execucao_do_projeto', 'fundos_estimados_do_verde_sinos', 'fundos_estimados_de_contra_partida', 'valor_total_do_projeto', 'municipio_ancora_do_projeto', 'instituicao_ancora_do_projeto', 'pessoa_ancora_do_projeto', 'inicio', 'fim',)
