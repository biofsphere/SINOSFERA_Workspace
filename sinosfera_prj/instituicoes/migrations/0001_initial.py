    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('responsavel_pela_instituicao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='pessoas.pessoa', verbose_name='Pessoa responsável, representante ou âncora da instituição')),
            ],
            options={
